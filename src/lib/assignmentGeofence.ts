 ...
 *  Geofence-specific (the only states where a position update from the
 *  agent's device can change the row). For broader status taxonomy
 *  (LIVE, BLOCKING, TERMINAL, etc.), import from `lib/assignmentStatus.ts`. */
